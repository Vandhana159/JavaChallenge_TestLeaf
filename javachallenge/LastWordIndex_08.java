...
public class LastWordIndex_08 {

	public static void main(String[] args) {
		String input = "luffy is still joyboy ";
		String[] words = input.split(" ");
		String lastWord = words[words.length-1];
		char[] lastWordInASentence = lastWord.toCharArray();
		System.out.println("The last word is "+lastWord +" with length "+(lastWordInASentence.length));
	}
}
